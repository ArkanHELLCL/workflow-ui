    ...
    return (
      <button        
        ...
        <svg 
            ...
            fill="none" 
            aria-hidden="true" 
            className={`${isOn ? `transition-transform scale-100 duration-300` :`transition-transform scale-0 duration-500`}`}>
        ...
        <svg 
            ...
            fill="none" 
            aria-hidden="true" 
            className={`${isOn ? `ml-3.5 transition-transform scale-0 duration-500` : `ml-3.5 transition-transform scale-100 duration-300`}`}>
        ...
        <span 
            className={`${isOn ? `absolute top-0.5 left-0.5 bg-white w-8 h-8 rounded-full flex items-center justify-center transition duration-500 translate-x-[2.625rem]` : `absolute top-0.5 left-0.5 bg-white w-8 h-8 rounded-full flex items-center justify-center transition duration-500 transform`}`}>
            <svg 
                width="24" 
                height="24" 
                fill="none" 
                aria-hidden="true" 
                className={`${isOn ? `flex-none transition duration-500 text-cyan-500 opacity-0 scale-0` : `flex-none transition duration-500 text-cyan-500 opacity-100 scale-100`}`}>
            ...
            <svg 
                ...
                fill="none" 
                aria-hidden="true" 
                className={`${isOn ? `flex-none -ml-6 transition duration-500 text-slate-700 opacity-100 scale-100` : `flex-none -ml-6 transition duration-500 text-slate-700 opacity-0 scale-0`}`}>
                <path d="M18 15.63c-.977.52-1.945.481-3.13.481A6.981 6.981 0 0 1 7.89 9.13c0-1.185-.04-2.153.481-3.13C6.166 7.174 5 9.347 5 12.018A6.981 6.981 0 0 0 11.982 19c2.67 0 4.844-1.166 6.018-3.37ZM16 5c0 2.08-.96 4-3 4 2.04 0 3 .92 3 3 0-2.08.96-3 3-3-2.04 0-3-1.92-3-4Z" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>
        </span>
      </button>
