...
export default function Buttons({formulario}){
    ...
    return(
        <div id="buttonsRequest" className='flex leading-tight absolute right-2 bottom-0 max-w-[60%] overflow-x-auto'>            
            {scrollON && scrollPosition > 0 &&
                <Button className="!sticky left-[1px] !top-1 !min-h-9 !h-9 flex !align-middle !items-center !content-center !w-5 !min-w-5 dark:!bg-[#666666] !bg-[#d4d4d4] opacity-90 !p-0 !rounded-none -!mt-2 z-50 hover:!bg-[#eff6fc] dark:hover:!bg-[#666666] !outline !outline-1 !outline-[#b8b5b2] dark:!outline-[#575757] hover:!outline-[#0078d4] hover:dark:!outline-[#b1b1b1]" onClick={()=>handleScrollX(-1)}>
            ...
            <div className='flex items-center gap-3 pb-2 pt-1 pr-[1px] pl-1'>
            {
                ...
                <>
                    <Button className="!sticky right-[2px] !top-1 !min-h-9 !h-9 flex !align-middle !items-center !content-center !w-5 !min-w-5 dark:!bg-[#666666] !bg-[#d4d4d4] opacity-90 !p-0 !rounded-none -!mt-2 z-50 hover:!bg-[#eff6fc] dark:hover:!bg-[#666666] !outline !outline-1 !outline-[#b8b5b2] dark:!outline-[#575757] hover:!outline-[#0078d4] hover:dark:!outline-[#b1b1b1]" onClick={()=>handleScrollX(1)}>
