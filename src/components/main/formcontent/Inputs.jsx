...
export default function Inputs({frmRequest, campos, filesList, setFilesList}){
    return(
            ...
            <div className="w-full pr-2">
                <div className='grid grid-cols-12 gap-2'>{        
                    campos?.map((campo) => {
                        ...
                        return(
                            <InputsType key={campo.FDI_NombreHTML} frmRequest={frmRequest} campo={campo} className={colwidth + ' relative pb-3'} filesList={filesList} setFilesList={setFilesList}/>
                        )}
                    )
                }
                </div>
