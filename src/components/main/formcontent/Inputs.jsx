...
export default function Inputs({campos, maintainer, setMaintainer}){
    return(
            ...
            <div className="w-full pr-2">
                <div className='grid grid-cols-12 gap-2'>{        
                    campos?.map((campo) => {
                        ...
                        return(
                            <InputsType key={campo.FDI_NombreHTML} campo={campo} className={colwidth + 'pb-3'} maintainer={maintainer} setMaintainer={setMaintainer}/>                                
                        )}
                    )
                }
                </div>
