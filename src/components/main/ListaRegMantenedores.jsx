...
const RegistroItem = ({registro, ...props}) => {
    const isRegSelected = false    
    return(
        <article className={`regitem flex relative dark:border-[#353535] border-[#d4d4d4] border-b pl-6 pr-3 py-2`} onClick={() => console.log('click reg')} {...props}>
            <div className="w-3/4">
...
export default function ListaRegMantenedores(){
    ...
    }, [filters.itemIdSelected, filters.stringSearch, filters.filterSearch])*/    
    return (        
