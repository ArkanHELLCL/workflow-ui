...
import { DeleteFileIcon, EnvelopePlusIcon, OpenFolderIcon, PrinterIcon, SaveAllIcon, SaveAllIconBig, SaveAsIcon, SaveAsIconBig } from "./icons.jsx";
    ...
    return (
        ...
        onDragOver={handleNotDragOver}>
            ...
            <section className="flex content-start gap-3 shrink px-2 relative pb-5 pt-1 border border-l-0 border-t-0 border-b-0 border-[#5c5a59]">
                ...
                <div className="flex flex-col gap-0 pr-2 items-center">
