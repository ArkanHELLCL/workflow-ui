...
export function IconForm({typeIcon, styles}){
    if(typeIcon === 'edit')
        return (
            <svg className={`w-5 h-5 dark:text-stone-100 text-stone-500 ${styles}`} aria-hidden="true" fill="currentColor" viewBox="0 0 20 18">
    ...
    if(typeIcon === 'month')
        return (
            <svg className={`w-5 h-5 dark:text-stone-100 text-stone-500 ${styles}`} aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
    ...
    if(typeIcon === 'factura')
        return (
            <svg className={`w-5 h-5 dark:text-stone-100 text-stone-500 ${styles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
    ...
    if(typeIcon === 'externo')
        return (
            <svg className={`w-5 h-5 dark:text-stone-100 text-stone-500 ${styles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
