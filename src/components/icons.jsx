...
export function BillIcon() {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 mr-2.5">
...
export function Icon({ open, pos }) {
    return (
      <svg
        ...
        strokeWidth={3}
        stroke="currentColor"
        className={`${open ? "" : "-rotate-90"} w-[.8rem] h-[.8rem] transition-transform absolute ${pos}`}
      >
