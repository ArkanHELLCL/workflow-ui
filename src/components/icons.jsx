...
export function SaveAllIcon(){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0.00 0.00 40.00 41.00">
            ...
            <path stroke="#8d5589" d="   M 33.15 22.05   L 19.74 22.00   Q 19.08 22.00 19.05 22.66   Q 18.85 27.95 19.14 33.26   Q 19.34 37.05 23.27 37.06   Q 28.29 37.08 33.00 36.95   A 0.99 0.99 0.0 0 0 33.96 35.96   L 33.99 22.90   A 0.85 0.84 -90.0 0 0 33.15 22.05"/>
            <path stroke="currentcolor" d="   M 26.98 17.06   A 0.31 0.31 0.0 0 0 27.19 16.53   L 22.50 11.84   A 0.31 0.31 0.0 0 0 21.97 12.05   L 21.94 16.77   A 0.31 0.31 0.0 0 0 22.26 17.09   L 26.98 17.06"/>
