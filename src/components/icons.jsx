    ...
    return(
        <div className="relative">
            ...
            <span className="absolute -bottom-3 -right-3">
                <svg viewBox="0 0 20 20" fill="none" className="h-9 w-9" strokeWidth="3">
    ...
    return(
        <div className="relative">
            ...
            <span className="absolute -bottom-2 -right-3">
                <svg viewBox="0 0 24 24" fill="none" className="h-9 w-9" strokeWidth="3">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"/>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
                    <g id="SVGRepo_iconCarrier"> 
...
export function MessagesIcon({styles, strokeWidth}){
    return(
        <svg viewBox="0 0 48 48" className={styles} strokeWidth={strokeWidth}>
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M41.47,7.28H6.53a2,2,0,0,0-2,1.88V31.41a2,2,0,0,0,2,1.88H9.14v7.43l8.26-7.43H41.47a2,2,0,0,0,2-1.88V9.16A2,2,0,0,0,41.47,7.28ZM14.25,17A3.25,3.25,0,1,1,11,20.29,3.24,3.24,0,0,1,14.25,17ZM24,23.54a3.25,3.25,0,1,1,3.25-3.25A3.26,3.26,0,0,1,24,23.54Zm9.75,0A3.25,3.25,0,1,1,37,20.29,3.26,3.26,0,0,1,33.75,23.54Z"/>
        </svg>
    )
}
