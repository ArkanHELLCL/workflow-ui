...
function App() {
  ...
  return (    
      <div className="dark:bg-[#262626] bg-[#ffffff] z-0 min-h-screen text-sm h-screen w-screen overflow-hidden relative pb-[30px] flex flex-col">
        <section className="dark:bg-[#0a0a0a] bg-sky-600 w-full h-[30px] z-50 transition-color delay-75" onDragOver={handleNotDragOver}>          
          <HeaderBar />          
        </section>
        ...
        <main className='w-full flex overflow-hidden pl-14 h-full'>
