...
export function BlockIcon({styles}){
    return(
...
export function CheckIcon({styles}){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={styles}>
...
export function CheckSmallIcon(){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 45 45" strokeWidth="1.5" stroke="currentColor" className="w-6 h- pt-2">
            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
        </svg>
    )
}
...
export function TableIconSave({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-2 -right-3">
                <svg viewBox="0 0 24 24" fill="#ca8a04" className="w-7 h-7">                    
                    <path d="M15.6287 5.12132L4.31497 16.435M15.6287 5.12132L19.1642 8.65685M15.6287 5.12132L17.0429 3.70711C17.4334 3.31658 18.0666 3.31658 18.4571 3.70711L20.5784 5.82843C20.969 6.21895 20.969 6.85212 20.5784 7.24264L19.1642 8.65685M7.85051 19.9706L4.31497 16.435M7.85051 19.9706L19.1642 8.65685M7.85051 19.9706L3.25431 21.0312L4.31497 16.435" stroke="#ca8a04" strokeLinecap="round" strokeLinejoin="round" fill="#ca8a04" strokeWidth={2}/>
                </svg>
            </span>
        </div>
...
export function TableIconBlock({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-2 -right-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-[#9333ea]">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636"  />
                </svg>
            </span>
        </div>
...
export function TableIconAllow({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-3 -right-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-7 h-7 text-[#16a34a]">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            </span>
        </div>
...
export function TableIconDel({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-2 -right-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-[#dc2626]">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                </svg>
            </span>
        </div>
...
export function TableIconNext({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-3 left-6">
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={'h7 w-7 text-[#bf6ac3]'}>
...
export function TableIconPrev({styles}){
    return(
        <div className="relative">
            <span>
                <svg fill="currentColor" viewBox="0 0 512 512" className={styles}>
            ...
            <span className="absolute -bottom-3 right-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={"2"} stroke="currentColor" className={'h7 w-7 text-[#bf6ac3]'}>
...
export function ButtonIcon({typeButton, styles, strokeWidth, typeIcon}){
    if(typeIcon===1){
        ...
        return(
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke="currentColor" className={styles + " text-[#16a34a]"}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
            </svg>
        )
        if(typeButton==='btn_bloquear')
        return(
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke="currentColor"  className={styles + ' text-[#9333ea]'}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636"  />
            </svg>
        )
        if(typeButton==='btn_crear')
        return(
            <svg viewBox="0 0 24 24" fill="none" className={styles} strokeWidth={strokeWidth}>
                <path d="M12 6V18" stroke="#16A34A" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6 12H18" stroke="#16A34A" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        )
        ...
        return(
            <svg viewBox="0 0 24 24" fill="#ca8a04" className={styles}>                    
                <path d="M15.6287 5.12132L4.31497 16.435M15.6287 5.12132L19.1642 8.65685M15.6287 5.12132L17.0429 3.70711C17.4334 3.31658 18.0666 3.31658 18.4571 3.70711L20.5784 5.82843C20.969 6.21895 20.969 6.85212 20.5784 7.24264L19.1642 8.65685M7.85051 19.9706L4.31497 16.435M7.85051 19.9706L19.1642 8.65685M7.85051 19.9706L3.25431 21.0312L4.31497 16.435" stroke="#ca8a04" strokeLinecap="round" strokeLinejoin="round" fill="#ca8a04" strokeWidth={strokeWidth}/>
            </svg>
        )
        ...
        if(typeButton==='btn_generar'){
            return (
                <svg viewBox="0 0 20 20" fill="none" className={styles}>
        ...
        if(typeButton==='btn_descargar'){
            return (
                <svg viewBox="0 0 24 24" fill="none" className={styles} strokeWidth="3">
        ...
        if(typeButton==='edit')
            return (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-8 h-8 ${styles} text-yellow-600`}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                </svg>
            )
        if(typeButton==='del')
            return (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke="currentColor" className={`w-8 h-8 ${styles}  text-[#dc2626]`}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                </svg>
            )
        if(typeButton==='new')
            return (
                <svg viewBox="0 0 24 24" fill="none" className={`w-8 h-8 ${styles}  text-green-600`} strokeWidth={strokeWidth}>
                    <path d="M12 6V18" stroke="#16A34A" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M6 12H18" stroke="#16A34A" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            )
    ...
    if(typeIcon===2){
        ...
        return(
            <div className="relative">
                ...
                <span className="absolute -top-1 -left-5">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className='h-7 w-7 text-lime-600'>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 00-1.883 2.542l.857 6a2.25 2.25 0 002.227 1.932H19.05a2.25 2.25 0 002.227-1.932l.857-6a2.25 2.25 0 00-1.883-2.542m-16.5 0V6A2.25 2.25 0 016 3.75h3.879a1.5 1.5 0 011.06.44l2.122 2.12a1.5 1.5 0 001.06.44H18A2.25 2.25 0 0120.25 9v.776" />
                    </svg>
                </span>
            </div>
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute -top-1 -left-5">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-7 w-7 text-green-600'}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 15l6-6m0 0l-6-6m6 6H9a6 6 0 000 12h3" />
                    </svg>
                </span>
            </div>            
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute top-0 -left-5">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-7 w-7 text-sky-600'}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 15l-6 6m0 0l-6-6m6 6V9a6 6 0 0112 0v3" />
                    </svg>
                </span>
            </div>
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute -top-1 -left-5">                    
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-8 w-8 text-green-700'}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg> 
                </span>
            </div>
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute -top-1 -left-5">                    
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-8 w-8 text-red-600'}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                    </svg> 
                </span>
            </div>
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute top-0 -left-5">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-6 w-6 text-sky-600'}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M14.25 9h2.25M5.904 18.75c.083.205.173.405.27.602.197.4-.078.898-.523.898h-.908c-.889 0-1.713-.518-1.972-1.368a12 12 0 01-.521-3.507c0-1.553.295-3.036.831-4.398C3.387 10.203 4.167 9.75 5 9.75h1.053c.472 0 .745.556.5.96a8.958 8.958 0 00-1.302 4.665c0 1.194.232 2.333.654 3.375z" />
                    </svg>
                </span>
            </div>                     
        ...
        return (
            <div className="relative">
                ...
                <span className="absolute top-0 -left-5">
                    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.35} stroke="currentColor" className={'h-6 w-6 text-red-600'}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.052.148.591 1.2.924 2.55.924 3.977a8.96 8.96 0 01-.999 4.125m.023-8.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.11.521 2.287.521 3.507 0 1.553-.295 3.036-.831 4.398C20.613 14.547 19.833 15 19 15h-1.053c-.472 0-.745-.556-.5-.96a8.95 8.95 0 00.303-.54m.023-8.25H16.48a4.5 4.5 0 01-1.423-.23l-3.114-1.04a4.5 4.5 0 00-1.423-.23H6.504c-.618 0-1.217.247-1.605.729A11.95 11.95 0 002.25 12c0 .434.023.863.068 1.285C2.427 14.306 3.346 15 4.372 15h3.126c.618 0 .991.724.725 1.282A7.471 7.471 0 007.5 19.5a2.25 2.25 0 002.25 2.25.75.75 0 00.75-.75v-.633c0-.573.11-1.14.322-1.672.304-.76.93-1.33 1.653-1.715a9.04 9.04 0 002.86-2.4c.498-.634 1.226-1.08 2.032-1.08h.384" />
                    </svg>
                </span>
            </div>
...
export function IconForm({typeIcon, styles}){
    if(typeIcon === 'edit')
        return (
            <svg className={`w-5 h-5 text-stone-400 ${styles}`} aria-hidden="true" fill="currentColor" viewBox="0 0 20 18">
    ...
    if(typeIcon === 'month')
        return (
            <svg className={`w-5 h-5 text-stone-400 ${styles}`} aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
    ...
    if(typeIcon === 'factura')
        return (
            <svg className={`w-5 h-5 text-stone-400 ${styles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" fill="none" d="M6 1v4a1 1 0 0 1-1 1H1m8-2h3M9 7h3m-4 3v6m-4-3h8m3-11v16a.969.969 0 0 1-.932 1H1.934A.97.97 0 0 1 1 18V5.828a2 2 0 0 1 .586-1.414l2.828-2.828A2 2 0 0 1 5.829 1h8.239A.969.969 0 0 1 15 2ZM4 10h8v6H4v-6Z"/>
            </svg>
        )
    if(typeIcon === 'externo')
        return (
            <svg className={`w-5 h-5 text-stone-400 ${styles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778" fill="none"/>
            </svg>
        )
    return null
}

export function ExternalMantainerIcon({titleMessage, error}){
    return(
        <div className={'h-[24px] w-7 dark:hover:!bg-[#444444] hover:!bg-[#f0f4f8] flex align-middle items-center !rounded-none content-center px-1 cursor-pointer group'} title={titleMessage}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={`w-6 h-4 group-hover:dark:!text-[#0b0d0e] group-hover:!text-[#0b0d0e] dark:!text-[#636b74] !text-[#636b74] ${error ? '!text-red-600 dark:!text-red-600 group-hover:!text-red-600 group-hover:dark:!text-red-600' : ''} `}>
